 ...
 * PYTHON AND ARDUINO
 * SEMESTER_1  (2018-19)
 * TEJAS DEEPAK AMLE (E18CSE190)
 * SUNEET JAIN       (E18CSE182)
 * YASH BANSAL       (E18CSE216)
 * BENNETT UNIVERSITY
 */

/*
 * By the help of this project you can control VLC player to Play/Pause and Volume Up or Down and Rewind/Forward by using hand gestures.
 */
